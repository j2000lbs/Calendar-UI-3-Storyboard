...
//		let numberOfColumns = rootViewController.propertyDelegate.numberOfColumns
//		let width =
...
//		let side = ((UIApplication.shared.keyWindow!.rootViewController as! UINavigationController).viewControllers.first as! RootViewController).calendarCollectionView.frame.width /
//						CGFloat(numberOfColumns) - numberOfColumnSpaces
...
//		numberOfRows = (numberOfItems + 6) / numberOfColumns // 7 columns, 7 days in a week
//		
